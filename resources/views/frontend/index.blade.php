                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="text-center pb-37 max-w-677 m-auto">
                            ...
                            <p class="fs-18 fw-400 lh-28 text-white">
                                {{ __('BUK Alumni (BUKAA) FCT chapter is a platform that helps alumni easily connect and manage their activities. Alumni can sign up and get approved by submitting necessary document.') }}
                            </p>
                        </div>
                        <!--  -->
